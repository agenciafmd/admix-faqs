...
@section('batch')
    @if(request()->is('*/trash'))
        ...
        @endcan
    @else
        @can('delete', \Agenciafmd\Faqs\Models\Faq::class)
                            ...
                            <td class="w-1 text-center">
                                <div class="item-action dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('update', \Agenciafmd\Faqs\Models\Faq::class)
